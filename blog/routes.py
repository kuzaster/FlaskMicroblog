...
from blog.forms import LoginForm, RegistrationForm, EditProfileForm, EditPostCommentForm, CreatePostCommentForm
...
def post(post_id):
    ...
    if form.validate_on_submit():
        if current_user.is_anonymous:
            ...
            return redirect(url_for('login'))
        comment = Comments(title=form.title.data, content=form.content.data, author=author, post=post)
...
def edit_post(post_id):
    ...
    return render_template('edit_post_comment.html', title='Edit Post', form=form, del_button=True)
...
def edit_comment(comment_id):
    ...
    return render_template('edit_post_comment.html', title='Edit comment', form=form, del_button=True)
